    ...
    <div className="py-[88px] bg-[#FFF] dark:bg-[hsl(var(--background))]" id="features">
      ...
      <div className="mt-[64px] max-w-[1600px] mx-auto overflow-hidden xl:scale-[100%] lg:w-[80%] md:w-[90%] max-sm:w-[96%]">
        <div className="rounded-[32px] bg-[#F4F9FF] dark:bg-[#102047] flex justify-center items-center p-14 max-sm:flex-col max-sm:p-[10px]">
          ...
          <img src="/asset/asseldark.png" className="dark:block hidden w-[564px]" alt={t("homepage.features.block1.imageAlt")} />
        </div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto overflow-hidden xl:scale-x-[100%] lg:w-[80%] md:w-[90%] max-sm:w-[96%] flex gap-3 max-sm:flex-col max-sm:mt-3 mt-3">
        ...
        <div className="bg-[#F4F9FF] dark:bg-[#102047] rounded-[32px] text-center p-14 gap-6 grid max-sm:p-[10px] lg:w-[50%]">
          <div className="text-center flex justify-center">
            ...
            <img src="/asset/Rent.png" alt={t("homepage.features.block3.imageAlt")} className="dark:block hidden w-[287px]"/>
          </div>
          <div className="">
            <h2 className="text-[#0B1A3E] dark:text-[#fff] text-xl font-black">
